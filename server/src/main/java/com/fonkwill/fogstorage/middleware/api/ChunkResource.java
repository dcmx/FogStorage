...
import com.fonkwill.fogstorage.middleware.shared.service.ChunkService;
...
/**
 * REST controller for managing {@link com.fonkwill.fogstorage.middleware.shared.domain.Chunk}.
 */
@RestController
@RequestMapping("/api")
